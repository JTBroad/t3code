...
// per environment/cwd/query, so continuous revalidation kept several
// repositories' worth of git processes running and starved the host. The idle
// TTL is what bounds that now: an unobserved atom stops refreshing entirely
