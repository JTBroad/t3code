...
import { ThreadClearReactor } from "./orchestration/Services/ThreadClearReactor.ts";
...
export const make = Effect.gen(function* () {
  ...
  const threadClearReactor = yield* ThreadClearReactor;
  ...
  const startup = Effect.gen(function* () {
    ...
    yield* runStartupPhase(
      ...
      Effect.gen(function* () {
        ...
        yield* threadClearReactor.start().pipe(Scope.provide(reactorScope));
