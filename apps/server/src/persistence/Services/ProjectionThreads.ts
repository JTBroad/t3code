...
export const ProjectionThread = Schema.Struct({
  ...
  // Serialized ThreadLinkedPullRequest, or null. Stored as JSON text — see
  // migration 041 for why this is one column rather than several.
  linkedPullRequest: Schema.optional(Schema.NullOr(Schema.String)),
