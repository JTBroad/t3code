...
export const CopilotIcon: Icon = ({ className, ...props }) => (
  <svg
    {...props}
    viewBox="0 0 24 24"
    fill="none"
  ...
  >
    {/* Simplified GitHub Copilot goggles mark */}
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M12 3.2c-3.72 0-6.02 1.05-7.08 2.13C3.6 6.68 3.4 8.53 3.4 9.6c0 .27.02.55.06.83C2.55 11 2 11.9 2 12.9v2.6c0 .53.21 1.04.59 1.41C4.6 18.9 8.06 20.8 12 20.8s7.4-1.9 9.41-3.89c.38-.37.59-.88.59-1.41v-2.6c0-1-.55-1.9-1.46-2.47.04-.28.06-.56.06-.83 0-1.07-.2-2.92-1.52-4.27C17.99 4.25 15.72 3.2 12 3.2Zm-5.62 3.5c.6-.62 2.25-1.5 5.62-1.5s5.02.88 5.62 1.5c.83.85.98 2.09.98 2.9 0 .84-.16 1.7-.62 2.16-.45.46-1.37.74-3.03.44a4.13 4.13 0 0 1-2.3-1.16c-.4-.42-.58-.87-.58-1.24 0-.2.02-.35.04-.47a6.7 6.7 0 0 0-2.22 0c.02.12.04.27.04.47 0 .37-.18.82-.58 1.24a4.13 4.13 0 0 1-2.3 1.16c-1.66.3-2.58.02-3.03-.44-.46-.47-.62-1.32-.62-2.16 0-.81.15-2.05.98-2.9ZM9 12.6c.34 0 .62.28.62.63v2.55a.62.62 0 1 1-1.25 0v-2.55c0-.35.28-.63.63-.63Zm6 0c.34 0 .62.28.62.63v2.55a.62.62 0 1 1-1.25 0v-2.55c0-.35.28-.63.63-.63Z"
    />
  </svg>
);
